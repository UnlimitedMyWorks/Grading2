            ...
            <div class="main-page">
                <div class="tables">
                    ...
                    <div class="panel-body widget-shadow">
                        <h4>CIA II Mark Entry</h4>
                        <form method = "post" action="CIA2markentry.php">
                            ...
                            <div class="form-group">
                                <label for="Coursecode" class="col-sm-2 control-label">Section</label>
                                <div class="col-sm-2">
                                ...
                                <input type="submit" class="btn-danger" name='submit' value="Enter">
                        </form>
                        </div>
                </div>
            </div>
