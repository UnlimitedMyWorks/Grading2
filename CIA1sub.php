<?php include('header.php');include("config.php");?>
            ...
            <div class="main-page">
                <div class="tables">
                    ...
                    <div class="panel-body widget-shadow">
                        <h4>CIA I questions</h4>
                        <form method = "get" action="CIA1qentry.php">
                            ...
                            <div class="form-group" id="displayhide" style =" display:none ">
                        <div class = "row">
        ...
        <script>
            $(document).ready(function(){
                $('#getcc').on('change', function() {
                    if ( this.value == 'CSE201')
                    {
                        $("#displayhide").show();
                    }
                    else
