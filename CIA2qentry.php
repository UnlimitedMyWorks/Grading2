<?php include('header.php');include("config.php");?>
      ...
      if(isset($_POST['coursecode1']))
      {
        ...
        if($cocd=='CSE201')
        {
            ...
            $sql1="INSERT INTO `cia2questions`(`coursecode`, `qno`, `qname`,  `courseoutcomecode`, `groupforfirstyear`,`weightage`) VALUES ('$cocd','$qno','$qname','$cono','$group','$cowt')";
        }
        else{
            $sql1="INSERT INTO `cia2questions`(`coursecode`, `qno`, `qname`,  `courseoutcomecode`, `weightage`) VALUES ('$cocd','$qno','$qname','$cono','$cowt')";
        }
        ECHO $sql1;
