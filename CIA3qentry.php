...
<form method="post">
    <div class ="grids widget-shadow">
        <div class="form-group">
            <div class = "row">
                <label for="Question No" class="col-sm-2 control-label" required="">Question No</label>
                <div class="col-sm-8">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class = "row">
                            ...
                            <input type="radio" onclick=" document.getElementById('add_cowt').value='<?php echo 2;?>';">Part A
                            </label>
                            <label class="radio-inline">
                            <input type="radio"  onclick=" document.getElementById('add_cowt').value=''">Part B
                            </label> 
                            <label class="radio-inline">
                            <input type="radio"  onclick=" document.getElementById('add_cowt').value=''">Part C
                            </label> 
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class = "row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control1"  name= "add_cowt" id="add_cowt" required="">
                            </div>
                        </div>
                    </div>
                    <div class ="form-group">
         ...
         if($cocd=='CSE201')
                     {
                        ...
                        $sql1="INSERT INTO `cia3questions`(`coursecode`, `qno`, `qname`,  `courseoutcomecode`, `groupforfirstyear`,`weightage`) VALUES ('$cocd','$qno','$qname','$cono','$group','$cowt')";
                     }
                     else
                     $sql1="INSERT INTO `cia3questions`(`coursecode`, `qno`, `qname`,  `courseoutcomecode`, `weightage`) VALUES ('$cocd','$qno','$qname','$cono','$cowt')";
         $result1=$mysqli->query($sql1);
         if($result1==true)
        {
           echo "<script> alert('Success Entry!!');</script>" ;
        }
        else
        {
           echo "<script>alert('Question Not Entered');</script>";
        }
      }
    ?>
