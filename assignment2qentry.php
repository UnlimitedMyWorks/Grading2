<?php include('header.php');include("config.php");?>
      ...
      <div id="page-wrapper">
      <div class="main-page">
      <h2 class="title1">Assignment II</h2>
      <form method="post">
      ...
      if(isset($_POST['coursecode1']))
        {
            ...
            if($result1==true )
            {
               echo "<script> alert('success entry');window.location = 'assignment2qentry.php?coursecode=".$cocd."';</script>" ;
            }
            else
            {
               echo "<script>window.location = 'assignment2qentry.php?coursecode=".$cocd."'; </script>";
            }
        }
?>
