<?php include('header.php');include("config.php");?>
      ...
      <div id="page-wrapper">
      <div class="main-page">
      <h2 class="title1">Assignment I</h2>
      <form method="post">
      ...
      if(isset($_POST['coursecode1']))
        ...
        $cowt=(int)filter_input(INPUT_POST,'add_cowt');
            ...
            if($result1==true )
            {
               echo "<script> alert('success entry');window.location = 'assignment1qentry.php?coursecode=".$cocd."';</script>" ;
            }
            else
            {
               echo "<script>window.location = 'assignment1qentry.php?coursecode=".$cocd."'; </script>";
            }
        }
?>
